...
plt.scatter(df_neg["GPS_LONG"], df_neg["GPS_LAT"], color="blue", s=15, label="Negativno")
plt.scatter(df_poz["GPS_LONG"], df_poz["GPS_LAT"], color="red", s=15, label="Pozitivno")

plt.legend(title="Metan")
plt.xlabel("Longitude")
plt.ylabel("Latitude")
